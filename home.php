...
<body>
    ...
    <script>
    // Monitorar eventos de teclado (para navegadores desktop)
    ...
    // Monitorar o evento 'beforeunload' (para navegadores desktop)
    window.addEventListener('beforeunload', function(event) {
        alert('Você tentou tirar um print de tela. O conteúdo está protegido.');
    });

    // Monitorar tamanho da janela (para navegadores desktop)
    ...
    // Detecção de captura de tela em dispositivos iOS
