<?php
    ...
    $sqlLocationLoggedUser = "SELECT latitude, longitude FROM user_locations WHERE user_id = ?";
    ...
    if ($locationLoggedUser) {
        ...
        $sql = "SELECT u.id, u.username, u.city, u.maritalStatus, u.avatar, l.latitude, l.longitude 
                FROM users u 
