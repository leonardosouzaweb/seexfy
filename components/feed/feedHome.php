      ...
      <div class="cards">
        <?php foreach ($users as $user): ?>
          <div class="user-card" 
              ...
              data-avatar="<?php echo !empty($user['avatar']) ? $base_url . '/uploads/avatars/' . $user['avatar'] : $base_url . '/images/defaultAvatar.svg'; ?>"
            ...
            <img src="<?php echo !empty($user['avatar']) ? $base_url . '/uploads/avatars/' . $user['avatar'] : $base_url . '/images/defaultAvatar.svg'; ?>" alt="Avatar">
            <div class="info">
